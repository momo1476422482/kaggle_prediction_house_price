...
class house_price_predicter:
    ...
    # ===============================================
    def __call__(self, algo: str, param_grid: Dict, threshold_feature_numerical: float = 0.5,
                 num_feature_category: int = 25):
...
if __name__ == '__main__':
    ...
    hp('svr', param_grid={'C': [140, 150], 'gamma': [0.1, 0.01, 0.001, 0.0001]}, threshold_feature_numerical=0,
       num_feature_category=40)
